...
def CreateHtml(filename,platform,program,day,group=None):
    with open(filename,"wb") as page:
        ...
        if platform == 'fengbo':
            ...
            page.write('<img style="border:none;" src="http://i3.sinaimg.cn/uc/sinashow4.0/2/logo.gif" alt="新浪SHOW" title="新浪SHOW"/></a></div></div>\n')
        ...
        #     f.write(commands.getoutput("/usr/bin/salt -N %s grains.item %s" % (group,platform))+'\n'+str(today))
